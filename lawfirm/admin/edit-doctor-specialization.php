...
if (isset($_POST['submit'])) {
	...
	$_SESSION['msg'] = "Lawyer Specialization updated successfully !!";
}
...
<head>
	<title>Admin | Edit Lawyer Specialization</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Edit Lawyer Specialization</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
								...
								<li class="active">
									<span>Edit Lawyer Specialization</span>
								</li>
							</ol>
						</div>
					</section>
									...
									<div class="col-lg-6 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Edit Lawyer Specialization</h5>
											</div>
